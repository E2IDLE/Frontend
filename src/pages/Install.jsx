...
const FAQS = [
  {
    q: "에이전트를 꼭 설치해야 하나요?",
    a: "네, DirectP2P Agent는 브라우저의 보안 정책 때문에 필요합니다. 브라우저만으로는 대용량 파일을 안정적으로 읽고 UDP 소켓을 직접 제어할 수 없어, 로컬에 경량 에이전트(48MB)를 설치해 초고속 전송을 구현했습니다. 웹 UI는 브라우저에서 그대로 사용하시면 됩니다.",
  },
  {
    q: "의심스러운 파일'이라며 설치를 차단합니다",
    a: "이는 신규 실행 파일에 대한 일반적인 경고이므로 '유지' 또는 '계속 다운로드'를 눌러 진행하시면 됩니다..",
  },
  {
    q: "상대방이 오프라인이면 전송이 안 되나요?",
    a: "맞습니다. P2P 특성상 양쪽이 동시에 연결되어 있어야 전송이 시작됩니다.",
  },
  {
    q: "회사 네트워크나 VPN 환경에서도 작동하나요?",
    a: "대부분의 환경에서 작동합니다. P2P 직접 연결이 막혀 있는 경우에는 TURN 릴레이 서버를 통해 자동으로 우회하여 연결합니다. 다만 이 경우 전송 속도가 다소 낮아질 수 있습니다.",
  },
];
